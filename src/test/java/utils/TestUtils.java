...
public class TestUtils {
  ...
  public static void assertThrowsExceptionMessage(String message, Class exceptionClass,
                                                  Executable executable) {
    Throwable exception = assertThrows(exceptionClass, executable);
    assertEquals(message, exception.getMessage());
  }

  public static void assertThrowsExceptionMessage(MockHttpServletResponse response,
                                                  String expectedMessage)
      throws JsonProcessingException, UnsupportedEncodingException {
    Throwable throwable = new ObjectMapper()
